(function () {
  ...
  (function () {
    ...
    var isForwardRef = function isForwardRef(value) {
      return value.includes('var(');
    };

    var isVarName = function isVarName(key) {
    ...
    var getAllRules = function getAllRules(declarations) {
      return declarations.filter(function (d) {
        ...
        return declarations.style.cssText.split(';');
      }).reduce(function (acc, declarations) {
        acc.push.apply(acc, _toConsumableArray(declarations));
        return acc;
      }, []).map(function (declaration) {
        return declaration.split(':').map(function (s) {
          return s.trim();
        });
    ...
    function cssVarUi() {
      ...
      Object.entries(result).forEach(function (_ref9) {
